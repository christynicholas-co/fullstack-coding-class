...
<!--"git branch -d [localbranch]"  deletes local branch in the terminal cmmand line-->
<!--"git branch -a" lists the branches available to delete-->
<!--"git push origin --delete [remotebranch]" deletes the remote branch-->


Score - 0
Not attempted
>>>>>>> 62237cbc6e4c7666afeac920e08ec33f8653a6c4

Regraded - not sure the first part is accurate BUT it looks good with what you did. 
I believe this could have been easily done.
What we were looking for was how to change the commit message.
I believe you can just use the git ammend command with the address of the commit.

Second part of the question is correct.

New Score - 90% - 10% for being past the time = 80%
