...
-->
db.Cluster0.distinct("type") returns ["dog", "cat", "cow"]
db.Cluster0.distinct("egg") returns ["duck", "hen", "ostrich"]
db.Cluster0.distinct("hello") returns animal ({hello: null })

## Question B:

In the above database, how would you count the number of mongo documents which contain a type "cat".
-->
db.Cluster0.count({type: "cat"})
...
Rescored - 100% - 10% for being late = 90%